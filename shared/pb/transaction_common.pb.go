...
const file_transaction_transaction_common_proto_rawDesc = "" +
	...
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12/\n" +
	"\x04data\x18\x03 \x03(\v2\x1b.pb.TransactionYearlyMethodR\x04data\"I\n" +
	...
	"\x04year\x18\x01 \x01(\x05R\x04year\"r\n" +
	"%MonthAmountTransactionMerchantRequest\x12\x12\n" +
	"\x04year\x18\x01 \x01(\x05R\x04year\x12\x14\n" +
	"\x05month\x18\x02 \x01(\x05R\x05month\x12\x1f\n" +
	"\vmerchant_id\x18\x03 \x01(\x05R\n" +
	"merchantId\"[\n" +
	"$YearAmountTransactionMerchantRequest\x12\x12\n" +
	"\x04year\x18\x01 \x01(\x05R\x04year\x12\x1f\n" +
	"\vmerchant_id\x18\x02 \x01(\x05R\n" +
	"merchantId\"r\n" +
	"%MonthMethodTransactionMerchantRequest\x12\x12\n" +
	"\x04year\x18\x01 \x01(\x05R\x04year\x12\x14\n" +
	"\x05month\x18\x02 \x01(\x05R\x05month\x12\x1f\n" +
	"\vmerchant_id\x18\x03 \x01(\x05R\n" +
	"merchantId\"[\n" +
...
var file_transaction_transaction_common_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_transaction_transaction_common_proto_goTypes = []any{
	...
	(*MonthAmountTransactionRequest)(nil),            // 23: pb.MonthAmountTransactionRequest
	(*YearAmountTransactionRequest)(nil),             // 24: pb.YearAmountTransactionRequest
	(*MonthMethodTransactionRequest)(nil),            // 25: pb.MonthMethodTransactionRequest
	(*YearMethodTransactionRequest)(nil),             // 26: pb.YearMethodTransactionRequest
	(*MonthAmountTransactionMerchantRequest)(nil),    // 27: pb.MonthAmountTransactionMerchantRequest
	(*YearAmountTransactionMerchantRequest)(nil),     // 28: pb.YearAmountTransactionMerchantRequest
	(*MonthMethodTransactionMerchantRequest)(nil),    // 29: pb.MonthMethodTransactionMerchantRequest
	(*YearMethodTransactionMerchantRequest)(nil),     // 30: pb.YearMethodTransactionMerchantRequest
...
var file_transaction_transaction_common_proto_depIdxs = []int32{
	31, // 0: pb.TransactionResponseDeleteAt.deleted_at:type_name -> google.protobuf.StringValue
	...
	32, // 5: pb.ApiResponsePaginationTransactionDeleteAt.pagination:type_name -> pb.PaginationMeta
	1,  // 6: pb.ApiResponsePaginationTransaction.data:type_name -> pb.TransactionResponse
	32, // 7: pb.ApiResponsePaginationTransaction.pagination:type_name -> pb.PaginationMeta
