...
const file_order_order_common_proto_rawDesc = "" +
	...
	"\x04data\x18\x03 \x03(\v2#.pb.OrderYearlyTotalRevenueResponseR\x04data\"E\n" +
	...
	"\x17FindYearOrderByMerchant\x12\x12\n" +
	"\x04year\x18\x01 \x01(\x05R\x04year\x12\x1f\n" +
	"\vmerchant_id\x18\x02 \x01(\x05R\n" +
...
var file_order_order_common_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_order_order_common_proto_goTypes = []any{
	...
	(*FindYearMonthTotalRevenue)(nil),           // 18: pb.FindYearMonthTotalRevenue
	(*FindYearTotalRevenue)(nil),                // 19: pb.FindYearTotalRevenue
	(*FindYearMonthTotalRevenueByMerchant)(nil), // 20: pb.FindYearMonthTotalRevenueByMerchant
	(*FindYearTotalRevenueByMerchant)(nil),      // 21: pb.FindYearTotalRevenueByMerchant
	(*FindYearOrder)(nil),                       // 22: pb.FindYearOrder
	(*FindYearOrderByMerchant)(nil),             // 23: pb.FindYearOrderByMerchant
	(*wrapperspb.StringValue)(nil),              // 24: google.protobuf.StringValue
	(*PaginationMeta)(nil),                      // 25: pb.PaginationMeta
}
var file_order_order_common_proto_depIdxs = []int32{
	24, // 0: pb.OrderResponseDeleteAt.deleted_at:type_name -> google.protobuf.StringValue
	...
	25, // 5: pb.ApiResponsePaginationOrderDeleteAt.pagination:type_name -> pb.PaginationMeta
	1,  // 6: pb.ApiResponsePaginationOrder.data:type_name -> pb.OrderResponse
	25, // 7: pb.ApiResponsePaginationOrder.pagination:type_name -> pb.PaginationMeta
