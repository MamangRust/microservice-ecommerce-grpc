...
const (
	merchantPolicyAllCacheKey     = "apigw:merchant_policy:all:page:%d:pageSize:%d:search:%s"
	merchantPolicyByIdCacheKey    = "apigw:merchant_policy:id:%d"
	merchantPolicyActiveCacheKey  = "apigw:merchant_policy:active:page:%d:pageSize:%d:search:%s"
	merchantPolicyTrashedCacheKey = "apigw:merchant_policy:trashed:page:%d:pageSize:%d:search:%s"
