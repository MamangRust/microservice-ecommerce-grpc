...
const (
	merchantAwardAllCacheKey     = "apigw:merchant_award:all:page:%d:pageSize:%d:search:%s"
	merchantAwardByIdCacheKey    = "apigw:merchant_award:id:%d"
	merchantAwardActiveCacheKey  = "apigw:merchant_award:active:page:%d:pageSize:%d:search:%s"
	merchantAwardTrashedCacheKey = "apigw:merchant_award:trashed:page:%d:pageSize:%d:search:%s"
