...
const (
	productAllCacheKey      = "apigw:product:all:page:%d:pageSize:%d:search:%s"
	productCategoryCacheKey = "apigw:product:category:%s:page:%d:pageSize:%d:search:%s"
	productMerchantCacheKey = "apigw:product:merchant:%d:page:%d:pageSize:%d:search:%s"

	productActiveCacheKey  = "apigw:product:active:page:%d:pageSize:%d:search:%s"
	productTrashedCacheKey = "apigw:product:trashed:page:%d:pageSize:%d:search:%s"
	productByIdCacheKey    = "apigw:product:id:%d"
