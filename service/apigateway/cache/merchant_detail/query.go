...
const (
	merchantDetailAllCacheKey          = "apigw:merchant_detail:all:page:%d:pageSize:%d:search:%s"
	merchantDetailByIdCacheKey         = "apigw:merchant_detail:id:%d"
	merchantDetailActiveCacheKey       = "apigw:merchant_detail:active:page:%d:pageSize:%d:search:%s"
	merchantDetailTrashedCacheKey      = "apigw:merchant_detail:trashed:page:%d:pageSize:%d:search:%s"
	merchantDetailRelationByIdCacheKey = "apigw:merchant:detail:relation:id:%d"
