...
const (
	orderItemAllCacheKey     = "apigw:order_item:all:page:%d:pageSize:%d:search:%s"
	orderItemActiveCacheKey  = "apigw:order_item:active:page:%d:pageSize:%d:search:%s"
	orderItemTrashedCacheKey = "apigw:order_item:trashed:page:%d:pageSize:%d:search:%s"
	orderItemByOrderCacheKey = "apigw:order_item:order:%d"
