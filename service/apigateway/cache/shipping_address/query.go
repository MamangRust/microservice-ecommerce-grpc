...
const (
	shippingAddressAllCacheKey     = "apigw:shipping_address:all:page:%d:pageSize:%d:search:%s"
	shippingAddressActiveCacheKey  = "apigw:shipping_address:active:page:%d:pageSize:%d:search:%s"
	shippingAddressTrashedCacheKey = "apigw:shipping_address:trashed:page:%d:pageSize:%d:search:%s"

	shippingAddressByOrderIdCacheKey = "apigw:shipping_address:order_id:%d"
	shippingAddressByIdCacheKey      = "apigw:shipping_address:id:%d"
