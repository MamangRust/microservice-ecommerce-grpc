...
const (
	merchantBusinessAllCacheKey     = "apigw:merchant_business:all:page:%d:pageSize:%d:search:%s"
	merchantBusinessByIdCacheKey    = "apigw:merchant_business:id:%d"
	merchantBusinessActiveCacheKey  = "apigw:merchant_business:active:page:%d:pageSize:%d:search:%s"
	merchantBusinessTrashedCacheKey = "apigw:merchant_business:trashed:page:%d:pageSize:%d:search:%s"
