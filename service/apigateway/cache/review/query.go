...
const (
	reviewAllCacheKey      = "apigw:review:all:page:%d:pageSize:%d:search:%s"
	reviewProductCacheKey  = "apigw:review:product:%d:page:%d:pageSize:%d:search:%s"
	reviewMerchantCacheKey = "apigw:review:merchant:%d:page:%d:pageSize:%d:search:%s"

	reviewByIdCacheKey    = "apigw:review:id:%d"
	reviewActiveCacheKey  = "apigw:review:active:page:%d:pageSize:%d:search:%s"
	reviewTrashedCacheKey = "apigw:review:trashed:page:%d:pageSize:%d:search:%s"
