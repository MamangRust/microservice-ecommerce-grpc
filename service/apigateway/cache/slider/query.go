...
const (
	sliderAllCacheKey     = "apigw:slider:all:page:%d:pageSize:%d:search:%s"
	sliderActiveCacheKey  = "apigw:slider:active:page:%d:pageSize:%d:search:%s"
	sliderTrashedCacheKey = "apigw:slider:trashed:page:%d:pageSize:%d:search:%s"
	sliderIdKey           = "apigw:slider:id:%d"
